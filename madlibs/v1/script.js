(function() {
    ...
    document.querySelector("form").addEventListener("submit", function(event) {
        ...
        if (word1Data == "") {
            ...
            document.querySelector("#madlibs-form1").innerHTML = '<div class="boxleft"><img src="images/redcat.png" alt="page1Image" width="450" height="358"></div><div class="textbox"><p><strong>Once upon a time,</strong> there was a cat named Little Red ' + capitalizedWord1 + ' Hood. They were a ' + word2Data + ' cat, and wanted to go into the ' + word3Data + ' woods to deliver fresh ' + word4Data + ' to Grandma Paw. However, the ' + word3Data + ' woods were known to be ' + word5Data + ' so Little Red ' + capitalizedWord1 + ' Hood had to be ' + word6Data + ' when traveling through these woods.</p><button type="button" id="story2">TURN PAGE >></button></div>'; 

            document.querySelector("#madlibs-form2").innerHTML = '<div class="boxleft"><img src="images/dog.png" alt="page2Dog" id ="dog" width="473" height="350"><img src="images/cat.png" alt="page2Cat" id="cat" width="357" height="341"></div><div class="textbox"><p>They ' + word7Data + ' navigated through the woods and was just about to reach Grandma Paw’s cottage when the Big ' + capitalizedWord8 + ' Dog showed up. The Big ' + capitalizedWord8 + ' Dog was looking for a playmate and chased Little Red ' + capitalizedWord1 + ' Hood into the nearby lake. </p><button type="button" id="story3">TURN PAGE >></button></div>'

            document.querySelector("#madlibs-form3").innerHTML = '<div class="boxleft"><img src="images/fish.png" alt="page3Image" width="617" height="263"></div><div class="textbox"><p>They played ' + word9Data + ' together until their ' + word10Data + ' human came to check up on them. The human finished the rest of the delivery and later that night, they all ' + word11Data + ' ate a ' + word12Data + ' dinner together at Grandma Paw’s cottage.</p><h2>THE END</h2><p id="tagline">Thanks for playing!</p><button type="submit" id="restart">PLAY AGAIN</button></div>'
        }; 
